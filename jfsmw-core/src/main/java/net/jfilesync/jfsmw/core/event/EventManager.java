...
public interface EventManager {
  <EV extends JfsMwEvent> EventPublisher<EV> forEvent(String eventId);

  <EV extends JfsMwEvent> EventPublisher<EV> forEvent(Class<EV> eventId);

  <EV extends JfsMwEvent> EventSubscription<EV> on(String eventId);

  <EV extends JfsMwEvent> EventSubscription<EV> on(Class<EV> eventId);
}
